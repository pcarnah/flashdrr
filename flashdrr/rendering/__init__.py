...
The camera helpers (:func:`get_vtk_view_mat`, :func:`carm_to_camera_params`,
:func:`get_random_carm_views`, ...) are the same ones the renderers use
internally and are re-exported for downstream code.
"""
